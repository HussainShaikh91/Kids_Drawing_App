...
import com.exaple.kidsdrawingapp.DrawingView
import com.exaple.kidsdrawingapp.R
...
class MainActivity : AppCompatActivity() {
    ...
    //this is for open Gallery for pick images
    val openGalleryLauncher:ActivityResultLauncher<Intent> = registerForActivityResult(ActivityResultContracts.StartActivityForResult()){result->
        if (result.resultCode == RESULT_OK && result.data != null){
            ...
            imageBackground.setImageURI(result.data?.data) //this is for set image in background
        }
    }
        ...
        registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()) { permissions ->
            permissions.entries.forEach {
                ...
                if (isGranted ) {
                    ...
                    //this is for open gallery for pick image
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnBrush: ImageButton = findViewById(R.id.btn_brush)
        drawingView?.setSizeForBrush(20.toFloat())
        //this is for default color paint is parsed
        val linearLayouPaintColors = findViewById<LinearLayout>(R.id.linearColor)
        mImageButtonCurrentPaint = linearLayouPaintColors[1] as ImageButton
        ...
        val btnUndo: ImageButton = findViewById(R.id.btn_undo)
        ...
        //this is for image pick from gallery
    ...
    private fun showBrushSizeChoserDialog() {
        ...
        smallBtn.setOnClickListener {
            //this is for default brush size
                ...
                try {
                    ...
                    runOnUiThread {
                        ...
                        if (!result.isEmpty()) {
                            ...
                            shareImage(result) //for share image
                        } else {
                            Toast.makeText(
                                this@MainActivity,
    ...
    private fun shareImage(result:String){
        ...
        MediaScannerConnection.scanFile(
            ...
            startActivity(Intent.createChooser(shareIntent, "Share"))// Activity Action: Display an activity chooser,
